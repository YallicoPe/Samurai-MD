...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🇦🇱 𝗦𝘂𝗽𝗲𝗿 𝗣𝗿𝗼𝘆𝗲𝗰𝘁𝗼-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl: yt }}}
