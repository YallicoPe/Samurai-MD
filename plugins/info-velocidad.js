...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🇦🇱 𝗦𝘂𝗽𝗲𝗿 𝗣𝗿𝗼𝘆𝗲𝗰𝘁𝗼-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(gataMenu)).buffer(), sourceUrl: accountsgb }}}
...
await conn.reply(m.chat, `${eg}🚀 𝙋𝙍𝙐𝙀𝘽𝘼 𝘿𝙀 𝙑𝙀𝙇𝙊𝘾𝙄𝘿𝘼𝘿...`, fkontak, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🇦🇱 𝗦𝘂𝗽𝗲𝗿 𝗣𝗿𝗼𝘆𝗲𝗰𝘁𝗼-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
...
await conn.sendFile(m.chat, gataImg, 'pp.jpg', caption, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🇦🇱 𝗦𝘂𝗽𝗲𝗿 𝗣𝗿𝗼𝘆𝗲𝗰𝘁𝗼-𝗠𝗗', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
